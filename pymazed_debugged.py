...
def move_player(maze, direction):
    ...
    if maze[new_pos[0]][new_pos[1]] == EXIT:
        print("Congratulations! You found the exit!")
        return "EXIT"  # The player has reached the exit
    elif maze[new_pos[0]][new_pos[1]] != WALL:
        if maze[new_pos[0]][new_pos[1]] == ITEM:
            print("Item collected!")  # Placeholder for item collection
...
def main():
    ...
    while True:
        ...
        if not moved:
            ...
            if moved == "EXIT":
                break  # Exit the game loop when the exit is reached        
